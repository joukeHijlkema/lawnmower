...
#ifndef SOURCES_FXAS21002C_H_
#define SOURCES_FXAS21002C_H_
...
{
    kStatus_FXAS_Success = 0x0, /*!< success */
    kStatus_FXAS_I2CFail = 0x1, /*!< I2C failure */
    kStatus_FXAS_Fail = 0x2     /*!< fail */
} FXAS_status_t;

FXAS_status_t FXAS21002C_WriteRegister(unsigned char reg, unsigned char val);
FXAS_status_t FXAS21002C_ReadRegisters(unsigned char reg, unsigned char n, unsigned char *val);

#endif /* SOURCES_FXAS21002C_H_ */
